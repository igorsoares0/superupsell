...
export async function syncOfferMetafield(
  ...
  const value = {
    ...
    cardBackgroundColor: offer.cardBackgroundColor,
    discountBgColor: offer.discountBgColor,
    discountTextColor: offer.discountTextColor,
...
export async function createOffer(
  ...
  return prisma.upsellOffer.create({
    data: {
      ...
      cardBackgroundColor: String(data.cardBackgroundColor || "#FFFFFF"),
      discountBgColor: String(data.discountBgColor || "#E53E3E"),
      discountTextColor: String(data.discountTextColor || "#FFFFFF"),
